...
Config.RandomDrugChance = true --if true it will enable random chance(if enabled there will be a 1 in 4 chance of the "Bad Trip" happening) if false a bad trip will occur every time
